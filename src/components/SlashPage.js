...
export default function SplashPage(props) {
  return (
    <>
    <div id="bg">
      <iframe src="https://player.vimeo.com/video/465498752?autoplay=1&loop=1&title=0&byline=0&portrait=0" width="2000" height="1000" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
    </div>
